...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../panel1" class="brand-link ">
      <img src="../dist/img/Jasamarga_Bali.webp" alt="Admin Logo" class="brand-image" style="opacity: .8">
      <span class="brand-text font-weight-light">Jasamarga Bali Tol</span>
    </a>
