...
document.getElementById("panid").text=" PANEL U-TURN AKAME";
document.getElementById("laporandaya").innerHTML = "<strong> PANEL U-TURN AKAME</strong>";
document.getElementById("laporan").innerHTML = "PANEL U-TURN AKAME";
...
async function getdata(){
    ...
    energis["Panel6"].series[0].points[0].update(parseInt(jadi[0]['energis']));
    energit["Panel6"].series[0].points[0].update(parseInt(jadi[0]['energit']));
    energitotal["Panel6"].series[0].points[0].update(parseInt(jadi[0]['energitotal']));
    dayatotal["Panel6"].series[0].points[0].update(parseInt(jadi[0]['dayatotal']));
    voltr["Panel6"].series[0].points[0].update(parseInt(jadi[0]['voltr']));
    volts["Panel6"].series[0].points[0].update(parseInt(jadi[0]['volts']));
    voltt["Panel6"].series[0].points[0].update(parseInt(jadi[0]['voltt']));
}
</Script>
</html>